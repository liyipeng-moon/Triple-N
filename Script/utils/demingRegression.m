...
% Performs Deming regression on x and y to estimate the slope accounting
% for errors in both variables, and computes a bootstrap-based confidence
% interval (CI) over 1000 resamples.
